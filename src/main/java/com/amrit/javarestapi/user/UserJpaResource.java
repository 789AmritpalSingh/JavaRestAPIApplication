...
public class UserJpaResource {
    ...
    public Post retrievePostForPostId(@PathVariable int id, @PathVariable int post_id) { // this method will retrieve description
        // for a particular post id by a particular user
